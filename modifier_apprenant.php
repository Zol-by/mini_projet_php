...
<?php
    ...
    $pdoStat = $bdd->prepare('SELECT * FROM apprenants WHERE id = :num');
                ...
                <div class="col-lg-6">
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-bg-dark" href="liste_apprenant.php"><strong>LISTE DES APRENANTS</strong></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-bg-dark" href="liste_tuteur.php"><strong>LISTE DES TUTAIRES</strong></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="mt-5"><strong><u>MODIFIER L'INFORMATION DE L'APPRENANT</u></strong></h2>
                <div class="card-body">
                    <form method="post" action="serv_mod_appre.php">
                        <div class="row bg-danger text-center rounded">
                            <div class="form-group">
                                <input class="form-control" type="hidden" name="numApprenant" value="<?= $contact['id']; ?>">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="firstName"></label>
                                <input type="date" class="form-control is-valid" name="date_naissance" value="<?= $contact['date_naissance']; ?>">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="addresse"></label>
                                <input type="text" class="form-control is-valid" name="pays" value="<?= $contact['pays']; ?>">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="email"> </label>
                                <input type="text" class="form-control is-valid" name="formation" value="<?= $contact['formation']; ?>">
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="firstName"></label>
                                <input type="text" class="form-control is-valid" name="tuteur" value="<?= $contact['tuteur']; ?>">
                            </div>
