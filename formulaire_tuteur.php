    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="mt-5"><strong>FORMULAIRE D'ENREGISTREMENT DES TUTEURS</strong></h2>
                <div class="card-body">
                    <form method="post" action="server_tuteur.php" enctype="multipart/form-data">
                        <div class="row bg-danger text-center rounded">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control is-valid" name="email" placeholder="Votre e-mail" required="">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="email"> </label>
                                <input type="text" class="form-control is-valid" name="grade" placeholder="Votre profession" required="">
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Voulez-vous enregistrer cette personne sur la liste des tuteurs ?</p>
                                        </div>
